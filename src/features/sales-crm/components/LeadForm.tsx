...
export function LeadForm({
  ...
  const validateStep = (s: number): boolean => {
    ...
    if (s === 1) {
      ...
      if (!form.wealthManagerId) newErrors.wealthManagerId = 'Wealth manager is required'
      if (!form.assignedEmployee.trim()) newErrors.assignedEmployee = 'Assigned employee is required'
    }
    ...
    const stepFields = s === 1
      ...
      : ['wealthManagerId', 'assignedEmployee']
